...
import com.Recipe.Recipe.services.IngredientService;
import com.Recipe.Recipe.services.RecipeService;
import com.Recipe.Recipe.services.UnitOfMeasureService;
...
public class IngredientController {
    ...
    public String newIngredient(@PathVariable String recipeId, Model model){
        ...
        RecipeCommand recipeCommand = (RecipeCommand) recipeService.findCommandById(Long.valueOf(recipeId));
